...
- **General** — клавиша push-to-talk; клавиша перевода и целевой язык; микрофон и правило
  ...
  буфера; звук; автозапуск; хранить last.wav; тайминги (порог hold, окно двойного тапа, хвост после
